...
; блокирует возможность перехватить курьера (спамит кнопку доставки). Включается по Numpad4, выключается по Numpad5

Numpad4::  ; Хоткей для включения
Loop 
{
SendInput {f4}  ; Бинд
If GetKeyState("Numpad5", "P")  ; Хоткей для выключения
Break
}
return
